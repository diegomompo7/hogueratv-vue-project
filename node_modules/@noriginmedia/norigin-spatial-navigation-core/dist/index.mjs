...
var SpatialNavigationService = /** @class */ (function () {
    ...
    SpatialNavigationService.prototype.init = function (_a) {
         ...
         * Native mode will be removed in the next version
         */
        nativeMode = _e === void 0 ? false : _e, _f = _b.throttle, throttleParam = _f === void 0 ? 0 : _f, _g = _b.throttleKeypresses, throttleKeypresses = _g === void 0 ? false : _g, _h = _b.useGetBoundingClientRect, useGetBoundingClientRect = _h === void 0 ? false : _h, _j = _b.shouldFocusDOMNode, shouldFocusDOMNode = _j === void 0 ? false : _j, _k = _b.domNodeFocusOptions, domNodeFocusOptions = _k === void 0 ? {} : _k, _l = _b.shouldUseNativeEvents, shouldUseNativeEvents = _l === void 0 ? false : _l, _m = _b.rtl, rtl = _m === void 0 ? false : _m, _o = _b.distanceCalculationMethod, distanceCalculationMethod = _o === void 0 ? 'corners' : _o, _p = _b.customDistanceCalculationFunction, customDistanceCalculationFunction = _p === void 0 ? undefined : _p, onUtterText = _b.onUtterText;
        if (!this.enabled) {
            ...
            this.onUtterText = onUtterText !== null && onUtterText !== void 0 ? onUtterText : undefined;
            this.debug = debug;
            if (!this.nativeMode) {
    ...
    SpatialNavigationService.prototype.addFocusable = function (_a) {
        var focusKey = _a.focusKey, node = _a.node, parentFocusKey = _a.parentFocusKey, onEnterPress = _a.onEnterPress, onEnterRelease = _a.onEnterRelease, onArrowPress = _a.onArrowPress, onArrowRelease = _a.onArrowRelease, onFocus = _a.onFocus, onBlur = _a.onBlur, saveLastFocusedChild = _a.saveLastFocusedChild, trackChildren = _a.trackChildren, onUpdateFocus = _a.onUpdateFocus, onUpdateHasFocusedChild = _a.onUpdateHasFocusedChild, preferredChildFocusKey = _a.preferredChildFocusKey, autoRestoreFocus = _a.autoRestoreFocus, forceFocus = _a.forceFocus, focusable = _a.focusable, isFocusBoundary = _a.isFocusBoundary, focusBoundaryDirections = _a.focusBoundaryDirections, accessibilityLabel = _a.accessibilityLabel;
     ...
     */
    SpatialNavigationService.prototype.utterAccessibilityLabels = function (newFocusKey) {
        var _this = this;
        if (!this.onUtterText) {
            return;
        }
        ...
        var newComponent = this.focusableComponents[newFocusKey];
        if (!newComponent) {
            return;
        }
        // Walk up the tree to collect all parents of the new focus key (bottom-up)
        var parentChain = [];
        var current = this.focusableComponents[newFocusKey];
        while (current) {
            var parentFocusKey = current.parentFocusKey;
            var parentComponent = this.focusableComponents[parentFocusKey];
            if (parentComponent) {
        ...
        var newlyEnteredParents = parentChain.filter(function (key) { return !_this.parentsHavingFocusedChild.includes(key); });
        ...
        var labels = [];
        newlyEnteredParents.forEach(function (parentKey) {
            var parent = _this.focusableComponents[parentKey];
            if (parent === null || parent === void 0 ? void 0 : parent.accessibilityLabel) {
